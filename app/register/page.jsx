      ...
      <section className="max-container min-h-screen padding flex items-center justify-center relative bg-blue-100">
        <div className="bg-white shadow-xl w-[350px] md:w-[500px] padding">
            ...
            <form className="flex flex-col space-y-6">
                ...
                <div>
                    <button type="button" onClick={handleSubmit} className="w-full bg-blue-400 text-white font-bold font-🇵alanquin p-2 rounded-md">Register</button>
                </div>
                <div className="flex justify-center">
                    <p className="text-sm font-palanquin">Already an Aidr member. <Link href="/register" className="cursor-pointer text-blue-400">Login</Link></p>
                </div>
            </form>
        </div>
      </section>
